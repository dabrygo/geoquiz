...
public interface IRegionFactory {
    ...
    default Region makeCountry(Continent code, boolean lightweight) {
        switch (code) {
        case ASIA:
...
class RegionFactory implements IRegionFactory {
    public Region regionFrom(Continent code) {
        return makeCountry(code, false);
    }
}

class LightweightRegionFactory implements IRegionFactory {
    public Region regionFrom(Continent code) {
...
abstract class Region extends ArrayList<IQuizCountry> {
    ...
    private void assignCountries() {
        ...
        try {
            ...
            BufferedReader reader = new BufferedReader(
                    new FileReader(Paths.get("rsc", "geoquiz", getFileName() + ".txt").toFile()));
    ...
    private void handleAsiaSpecialCases(HashMap<String, Country> codesToNames) {
        ...
        codesToNames.put("Akrotiri and Dhekelia", Country.GR); // minoan bronze
                                                               // age settlement
        ...
        codesToNames.put("South Ossetia", Country.GE);// partially recognized
                                                      // state
    }
    ...
    private void handleEuropeSpecialCases(HashMap<String, Country> codesToNames) {
        ...
        codesToNames.put("Transnistria", Country.MD); // recognized as part of
                                                      // moldova
    ...
    private String getFileName() {
        ...
        case "Asia":
            return Continent.ASIA.name();
        case "Africa":
            return Continent.AFRICA.name();
        case "NorthAmerica":
            return Continent.NORTH_AMERICA.name();
        case "SouthAmerica":
            return Continent.SOUTH_AMERICA.name();
        case "Europe":
            return Continent.EUROPE.name();
        case "Australia":
            return Continent.AUSTRALIA.name();
        case "World":
        default:
